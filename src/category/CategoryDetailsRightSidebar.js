...
class CategoryDetailsRightSidebar extends Component{
    render(){
                            ...
                            <div className="col">
                                <div className="page-banner text-center">
                                    ...
                                    <ul className="page-breadcrumb">
                                        <li><a href="/">Home</a></li>
                                        <li><a href={`${process.env.PUBLIC_URL}/categories`}>Categories</a></li>
...
export default CategoryDetailsRightSidebar;