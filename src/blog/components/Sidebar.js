...
class Sidebar extends Component{
    render(){
        ...
        let popularPostData = [
            {postImage: 'sidebar-blog-1.jpg', postTitle: 'What are new limited editions?', postLink: 'blog-details-left-sidebar', postDate: '30 October 2019'},
            {postImage: 'sidebar-blog-2.jpg', postTitle: 'What are new limited editions?', postLink: 'blog-details-left-sidebar', postDate: '30 October 2019'},
            {postImage: 'sidebar-blog-3.jpg', postTitle: 'What are new limited editions?', postLink: 'blog-details-left-sidebar', postDate: '30 October 2019'}
        ];
            ...
            return(
                ...
                <a href="blog-details-left-sidebar.html" className="image"><img src={`assets/img/blog/${val.postImage}`} alt="" /></a>
                    <div className="content">
                        <h5><a href={`${process.env.PUBLIC_URL}/${val.postLink}`}>What are new limited editions?</a></h5>
