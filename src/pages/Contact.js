                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>Boston, MA</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:1234567890">111 222 3333</a><a href="tel:1234567890">222 333 4444</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:info@example.com">xxx@email.com</a><a href="mailto:info@example.com">xxx@gmail.com</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
